...
export function PmLabResearchPreview() {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center p-6 lg:p-8">
      ...
      <div className="relative z-10 flex w-full max-w-lg flex-col gap-4 rounded-xl border border-white/10 bg-white/[0.01] p-4 shadow-xl backdrop-blur-sm">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="flex flex-col gap-2 rounded-lg border border-white/5 bg-white/[0.02] p-3 transition-colors hover:bg-white/[0.04]">
            ...
            <div className="flex h-16 items-end gap-1 pt-2">
              <div className="h-[90%] w-full rounded-t-sm bg-blue-500/30 transition-all hover:bg-blue-500/50" />
            </div>
          ...
          <div className="flex flex-col gap-2 rounded-lg border border-white/5 bg-white/[0.02] p-3 transition-colors hover:bg-white/[0.04]">
            ...
            <div className="flex h-16 items-end gap-1 pt-2">
              <div className="h-[65%] w-full rounded-t-sm bg-amber-500/30 transition-all hover:bg-amber-500/50" />
            </div>
            <div className="text-foreground/80 mt-1 text-center font-mono text-[10px]">
              65%
            </div>
          ...
          <div className="relative flex flex-col gap-2 overflow-hidden rounded-lg border border-white/5 bg-white/[0.02] p-3 transition-colors hover:bg-white/[0.04]">
            ...
            <div className="z-10 flex h-16 items-end gap-1 pt-2">
              <div className="h-[42%] w-full rounded-t-sm bg-green-500/50 transition-all hover:bg-green-500/70" />
            </div>
            <div className="z-10 mt-1 text-center font-mono text-[10px] font-semibold text-green-400">
              42%
            </div>
            {/* Abstract gradient for edge */}
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-green-500/20 to-transparent" />
          </div>
        </div>
